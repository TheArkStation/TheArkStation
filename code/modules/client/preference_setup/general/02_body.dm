...
/datum/category_item/player_setup_item/physical/body/load_character(var/savefile/S)
	...
	from_save(S["skin_base"], pref.s_base)
	...
	from_save(S["body_markings"], pref.body_markings)
	from_save(S["body_descriptors"], pref.body_descriptors)
	pref.preview_icon = null
	from_save(S["bgstate"], pref.bgstate)

/datum/category_item/player_setup_item/physical/body/save_character(var/savefile/S)
	to_save(S["species"], pref.species)
	to_save(S["hair_red"], pref.r_hair)
	to_save(S["hair_green"], pref.g_hair)
	to_save(S["hair_blue"], pref.b_hair)
	to_save(S["facial_red"], pref.r_facial)
	to_save(S["facial_green"], pref.g_facial)
	to_save(S["facial_blue"], pref.b_facial)
	to_save(S["skin_tone"], pref.s_tone)
	to_save(S["skin_red"], pref.r_skin)
	to_save(S["skin_green"], pref.g_skin)
	to_save(S["skin_base"], pref.s_base)
	to_save(S["skin_blue"], pref.b_skin)
	to_save(S["hair_style_name"],pref.h_style)
	to_save(S["facial_style_name"],pref.f_style)
	to_save(S["eyes_red"], pref.r_eyes)
	to_save(S["eyes_green"], pref.g_eyes)
	to_save(S["eyes_blue"], pref.b_eyes)
	to_save(S["b_type"], pref.b_type)
	to_save(S["disabilities"], pref.disabilities)
	to_save(S["organ_data"], pref.organ_data)
	to_save(S["rlimb_data"], pref.rlimb_data)
	to_save(S["body_markings"], pref.body_markings)
	to_save(S["body_descriptors"], pref.body_descriptors)
	to_save(S["bgstate"], pref.bgstate)

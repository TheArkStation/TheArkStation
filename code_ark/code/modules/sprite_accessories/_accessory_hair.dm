#define ICONS_PATH 'code_ark/icons/mob/human_races/species/human/hair.dmi'

/datum/sprite_accessory/hair/mads
	name = "Mads"
	icon = ICONS_PATH
	icon_state = "hair_mads"
	gender = MALE

/datum/sprite_accessory/hair/taylor
	name = "Taylor"
	icon = ICONS_PATH
...
/datum/sprite_accessory/hair/long_braided_hair
	name = "Long braided"
	icon = ICONS_PATH
...
/datum/sprite_accessory/hair/ponytail4TG
	name = "Ponytail 4(TG)"
	icon = ICONS_PATH
...
/datum/sprite_accessory/hair/beyfong
	name = "Beyfong"
	icon = ICONS_PATH
...
/datum/sprite_accessory/hair/longsidepartstraight
...
/datum/sprite_accessory/hair/sloppybunch
	name = "Sloppy Bunch"
	icon = ICONS_PATH

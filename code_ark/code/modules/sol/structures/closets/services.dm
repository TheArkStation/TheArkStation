/decl/closet_appearance/secure_closet/sol/hydroponics
	extra_decals = list(
...
/obj/structure/closet/chefcloset_sol
	name = "chef's closet"
...
/obj/structure/closet/secure_closet/hydroponics_sol //done so that it has no access reqs
	name = "hydroponics locker"
	req_access = list()
	closet_appearance = /decl/closet_appearance/secure_closet/sol/hydroponics

/obj/structure/closet/secure_closet/hydroponics_sol/WillContain()
	return list(
...
/*/obj/structure/closet/secure_closet/bar_torch // UNUSED
	name = "bar locker"

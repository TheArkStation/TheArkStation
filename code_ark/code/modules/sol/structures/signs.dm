/obj/structure/sign/dedicationplaque
	name = "\improper dedication plaque"
	icon_state = "lightplaque"

/obj/structure/sign/dedicationplaque/lucius
	name = "\improper SEV Lucius dedication plaque"

/obj/structure/sign/dedicationplaque/lucius/Initialize() // FIX ME
	. = ..()

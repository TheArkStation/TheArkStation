...
//[ARK]
	sprite_sheets = list(
		SPECIES_UNATHI = 'code_ark/icons/mob/onmob/sol/unathi/onmob_suit_solgov_unathi.dmi',
		SPECIES_SKRELL = 'code_ark/icons/mob/onmob/sol/skrell/onmob_suit_solgov_skrell.dmi',
	...
	sprite_sheets_obj = list(
		SPECIES_UNATHI = 'code_ark/icons/obj/clothing/sol/unathi/obj_suit_solgov_unathi.dmi',
		SPECIES_SKRELL = 'code_ark/icons/obj/clothing/sol/skrell/obj_suit_solgov_skrell.dmi',
		SPECIES_TAJARA = 'code_ark/icons/mob/species/tajara/suits.dmi',
...
//[ARK]
	sprite_sheets = list(
		SPECIES_SKRELL = 'code_ark/icons/mob/onmob/sol/skrell/onmob_head_solgov_skrell.dmi',
		SPECIES_TAJARA = 'code_ark/icons/mob/species/tajara/helmet.dmi',//ARK
		SPECIES_RESOMI = 'code_ark/icons/mob/species/resomi/onmob_head_resomi.dmi'//ARK
		)
	sprite_sheets_obj = list(

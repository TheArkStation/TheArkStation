/obj/item/clothing/glasses/sunglasses/lenses
	...
	item_icons = list(slot_glasses_str = 'code_ark/code/modules/species/station/resomi/sprite_cloth/onmob_eyes_resomi.dmi')
	icon = 'code_ark/code/modules/species/station/resomi/sprite_cloth/obj_eyes_resomi.dmi'

/obj/item/clothing/glasses/tajblind
	...
	icon_state = "tajblind"
	item_state = "tajblind"
	item_icons = list(slot_glasses_str = 'code_ark/code/modules/species/station/tajara/sprites_cloth/onmob_eyes.dmi')
	icon = 'code_ark/code/modules/species/station/tajara/sprites_cloth/obj_eyes.dmi'
	prescription = 5

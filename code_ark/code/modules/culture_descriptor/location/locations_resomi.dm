/*decl/cultural_info/location/kuih
	name = HOME_SYSTEM_RESOMI_TIAMATH
	description = "\\\\"
...
decl/cultural_info/location/eremus
	...
	description = "Эремус, планета расположенная в системе Голгенна, имеет суперконтинент с двумя огромными морями соединёнными между собой сетью рек. \
	 ...
	 от многочисленных коммун и \"сухопутных карет\" до разношёрстных преступных группировок, которыми богата данная планеты.<br><br> \
...
/decl/cultural_info/location/r_lost_colony
...
/decl/cultural_info/location/r_refuge_colony
	...
	description = "Малоизвестная  колония  имперских беженцев, одна из бесчисленного множества подобных.<br><br> <font color=\"#a50aff\">Резоми</font>, покидающие Империи с большим запасом снабжения и ресурсов, \
...
/*decl/cultural_info/location/imperial_colony

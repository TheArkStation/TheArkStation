...
/datum/robolimb/resomi
	...
	icon = 'code_ark/icons/mob/human_races/cyberlimbs/resomi/resomi_main.dmi'
...
/datum/robolimb/hephaestus/special
	...
	icon = 'code_ark/icons/mob/human_races/cyberlimbs/hephaestus/hephaestus_special.dmi'
...
/datum/robolimb/hephaestus/athena
	...
	icon = 'code_ark/icons/mob/human_races/cyberlimbs/hephaestus/hephaestus_athena.dmi'

/datum/robolimb/xion/special
	company = "Xion Special"
	icon = 'code_ark/icons/mob/human_races/cyberlimbs/xion/xion_special.dmi'

/datum/robolimb/wardtakahashi/special
	company = "Ward-Takahashi Special Upper"
	icon = 'code_ark/icons/mob/human_races/cyberlimbs/wardtakahashi/wardtakahashi_special.dmi'
...
/datum/robolimb/morpheus/special
	...
	icon = 'code_ark/icons/mob/human_races/cyberlimbs/morpheus/morpheus_special.dmi'